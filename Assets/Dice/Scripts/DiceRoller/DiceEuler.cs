...
public class DiceEuler : MonoBehaviour
{
    public Dictionary<int, Quaternion> faceRotationsD20 = new Dictionary<int, Quaternion>
        {
    ...
    public Dictionary<int, Quaternion> faceRotationsD10 = new Dictionary<int, Quaternion>
        {
    ...
    public Dictionary<int, Quaternion> faceRotationsD6 = new Dictionary<int, Quaternion>
        {
    ...
    public Dictionary<int, Vector3> facePositionsD6 = new Dictionary<int, Vector3>
        {
